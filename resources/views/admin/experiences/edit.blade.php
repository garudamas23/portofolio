...
@section('content')
    <div class="mb-6">
        <h1 class="text-2xl font-bold">Edit Pengalaman</h1>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="current" value="1" {{ old('current', $experience->current) ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="4" required
                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">{{ old('description', $experience->description) }}</textarea>
                </div>
            </div>
