...
@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-bold">Tambah Skill Baru</h1>
</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select name="level" id="level" required
                    ...
                    @for($i = 1; $i <= 5; $i++)
                        <option value="{{ $i }}">{{ $i }} - {{ $i == 1 ? 'Pemula' : ($i == 5 ? 'Ahli' : 'Menengah') }}</option>
                    @endfor
                </select>
            </div>
            ...
            <div>
                ...
                <input type="text" name="icon" id="icon" placeholder="contoh: laravel, react, js"
                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
